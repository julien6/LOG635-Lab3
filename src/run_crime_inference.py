...
a = InferenceCrime.CrimeInference()
...
sents0 = 'Scarlet est morte'
print(getStringResults(nltk.interpret_sents(sents0, '635/personne_morte.fcfg')))
...
#
# # On ajoute la clause pour avoir l'heure après qu'une heure se soit écoulé à la suite du meurtre
